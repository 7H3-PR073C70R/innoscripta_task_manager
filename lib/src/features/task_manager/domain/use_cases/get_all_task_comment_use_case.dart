...
class GetAllTaskCommentUseCase
    implements UseCase<List<TaskCommentEntity>, GetCommentsFilterEntity> {
  const GetAllTaskCommentUseCase(this._repository);
  final TaskManagerRepository _repository;

  @override
  Future<Either<Failure, List<TaskCommentEntity>>> call(
    GetCommentsFilterEntity param,
  ) {
    return _repository.getAllTaskComment(param);
  }
}
