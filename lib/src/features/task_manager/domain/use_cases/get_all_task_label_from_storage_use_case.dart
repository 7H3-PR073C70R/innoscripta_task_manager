...
class GetAllTaskLabelFromStorageUseCase
    implements UseCase<List<TaskLabelEntity>, GetActiveTasksFilterEntity> {
  const GetAllTaskLabelFromStorageUseCase(this._repository);
  final TaskManagerRepository _repository;

  @override
  Future<Either<Failure, List<TaskLabelEntity>>> call(
    GetActiveTasksFilterEntity param,
  ) {
    return _repository.getAllTaskLabelFromStorage(param);
  }
}
