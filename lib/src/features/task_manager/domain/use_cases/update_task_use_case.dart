...
class UpdateTaskUseCase implements UseCase<TaskEntity, CreateTaskEntity> {
  const UpdateTaskUseCase(this._repository);
  final TaskManagerRepository _repository;

  @override
  Future<Either<Failure, TaskEntity>> call(CreateTaskEntity param) {
    return _repository.updateTask(param);
  }
}
